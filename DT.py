...
new_data = [[60, 1, 1, 2, 60, 2]]  # ตัวอย่างข้อมูลใหม่ (อายุ 40, เพศชาย, สภาพสุขภาพดี, ระดับฟิตปานกลาง, 45 นาที, ความเข้มข้นสูง)
new_data_scaled = scaler.transform(new_data)  # ต้องทำการ scale เช่นเดียวกับข้อมูลการฝึก
